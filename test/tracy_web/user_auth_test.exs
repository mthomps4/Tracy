defmodule TracyWeb.UserAuthTest do
  use TracyWeb.ConnCase, async: true

  alias Tracy.Accounts
  alias Tracy.Accounts.Scope
  alias TracyWeb.UserAuth

  import Tracy.AccountsFixtures

  @remember_me_cookie "_tracy_web_user_remember_me"
  @remember_me_cookie_max_age 60 * 60 * 24 * 14

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, TracyWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
